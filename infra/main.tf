...
#     vpc_id = module.vpn_s2s_aws_azure.vpn_connection_ouptut.aws_vpn_network_info.vpc.id
#     subnet_id = module.vpn_s2s_aws_azure.vpn_connection_ouptut.aws_vpn_network_info.subnet[0].id
...
#     subnet_id = module.vpn_s2s_aws_azure.vpn_connection_ouptut.azure_vpn_network_info[0].subnet[1].id
